...
while True:
    ...
    source_details=oci.core.models.InstanceSourceViaBootVolumeDetails(source_type="bootVolume", boot_volume_id=imageId,custom boot volume size - ,boot_volume_size_in_gbs=65)
